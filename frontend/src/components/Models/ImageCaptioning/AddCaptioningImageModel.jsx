...
const AddCaptioningImageModel = ({ visible, onClose, onAddModel }) => {
  ...
  const onFinish = (values) => {
    ...
    modelService.createImageCaptioningModel(formData).then(
      (response) => {
        toast.success("Modèle de captioning d'image ajouté avec succès");
  ...
  return (
    <Drawer
      title="Add new captioning image model"
      onClose={onClose}
      visible={visible}
...
export default AddCaptioningImageModel;
