...
import AddSegmentationModelDrawer from './AddSegmentationModelDrawer';
// import AddDemandDrawer from '../components/AddDemandDrawer'; // Importer le composant du Drawer
import { EditOutlined, DeleteOutlined } from '@ant-design/icons';
import UpdateModelDrawer from './UpdateModelDrawer';
...
const fetchData = () => {
  setLoading(true);
  modelService.getSegmentationModels()
    .then(response => {
  ...
  const handleDelete = (record) => {
    confirm({
      ...
      onOk() {
        ...
        modelService.deleteSegmentationModel(record.id)
          .then(() => {
...
// };
  ...
  return (
    <div className="relative">
      ...
      <h1 className="text-lg font-semibold mb-4">Segmentation models list</h1>
